...
def load():
    ...
    load, iterate, read, write, text, relchain, save = [], [], [], [], [], [], []
    for _ in range(10):
    ...
    for x, y in [('load', load), ('iter', iterate), ('read', read), ('write', write), ('text', text), ('relchain', relchain), ('save', save)]:
