...
//  Modified by Troy D. Straszheim and Jakob van Santen, 2009-03-26 (http://boost.2283326.n4.nabble.com/map-indexing-suite-interface-td2702276.html)
//  Modified by Dmytro Kalpakchi, 2020-07-28

#ifndef MAP_INDEXING_SUITE_V2_JDG20038_HPP
#define MAP_INDEXING_SUITE_V2_JDG20038_HPP
...
namespace boost { namespace python {
    ...
    namespace detail {
        ...
        class final_map_v2_derived_policies
            : public map_indexing_suite_v2<Container,
                NoProxy, final_map_v2_derived_policies<Container, NoProxy> > {};
    }
    ...
    public:
        ...
        static typename Container::key_type get_key(typename Container::value_type& e) {
            return e.first;
        }
        ...
        static void extension_def(Class& cl) {
            ...
            typedef typename mpl::if_<
                mpl::and_< mpl::or_<is_class<data_type>, is_class<data_type&> >, mpl::bool_<!NoProxy> >
            ...
            class_<value_type>(elem_name.c_str())
                ...
                // if this is a data element, this won't work, but we assume that the keys will be standard hashable elements
...
#endif // MAP_INDEXING_SUITE_JDG20038_V2 HPP 